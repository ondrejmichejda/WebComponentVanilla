      ...
      <div class="outer-body">
        <div class="body">
          ...
          <div class="currencies">
            <div id="cur-universal" class="currency active">${t?.[13].trim()}</div>
            <div id="cur-eur" class="currency">EUR</div>
          </div>
          </div>
    
          <div class="title">${t?.[1]??"undefined"}(<span id="cur-span" class="currency">${t?.[13].trim()}</span>)</div>
