    ...
    <div class="calculator">
      <div class="outer-body">
        <div class="body">
          ...
          <div class="title">${t?.[1]??"undefined"}(<span id="cur-span" class="currency">CZK</span>)</div>
          <div class="slider-value" id="slider1-value">1000 CZK</div>
          <div id="slider1" class="slider"></div>
          <div class="slider-bottom"></div>
    
          <div class="title">${t?.[2]??"undefined"}</div>
          ...
          <table class="table">
            <tr class="row1">
              <td class="left">
                <div class="row-text"><span class="text">${t?.[3]??"undefined"}
                <span>${t?.[4]??"undefined"}</span>
                ${t?.[5]??"undefined"}</span><span class="line"></span></div>
              </td>
              <td id="row1-value" class="right">-</td>
            </tr>
            <tr class="row2">
              <td class="left">
                <div class="row-text"><span class="text">${t?.[6]??"undefined"}</span><span class="line"></span></div>
              </td>
              <td id="row2-value" class="right">-</td>
            </tr>
            <tr class="row3">
              <td class="left">
                <div class="row-text"><span class="text">${t?.[7]??"undefined"}</span><span class="line"></span></div>
              </td>
              <td id="row3-value" class="right">-</td>
            </tr>
          </table>
    
          <div style="text-align: center"><a class="button" href="${e}">${t?.[8]??"undefined"}</a></div>
